...
<img src="https://github.com/blackosx/BsxDebossBluePlain/blob/main/preview_ui.jpg" alt="theme_preview" border="0">

<img src="https://github.com/blackosx/BsxDebossBluePlain/blob/main/preview_password.jpg" alt="theme_preview" border="0">
...
**Using this theme**<br>
This repository contains a Blackosx directory with a sub-directory BsxDebossBluePlain which contains all necessary ICNS files for the theme.
...
- then just add the BsxDebossBluePlain directory

Either way, for this theme you will want to end up having
EFI/OC/Resources/Image/Blackosx/BsxDebossBluePlain

You can switch the icon set used by OpenCanopy by changing the 'PickerVariant' key in OpenCore's config.plist to match the vendor and theme name of the icon set you want to display. So to instruct OpenCanopy to use this icon set you want to set the PickerVariant key to Blackosx\BsxDebossBluePlain

```
                <key>PickerVariant</key>
                <string>Blackosx\BsxDebossBluePlain</string>
```
